...
| 6 | [Door & Room Management](features/06_Door_Room_Management.md) | Single-Scene Architecture butuh sistem visibilitas ruangan supaya performa aman sebelum level digambar penuh. | Belum dikerjakan |
...
| 8 | [Story Engine & Flag System](features/08_Story_Engine_Flags.md) | Menghubungkan checkpoint cerita ke perubahan dunia nyata (posisi NPC, munculnya item, status pintu) via registry di #3. | Belum dikerjakan |
| 9 | [Psychological Distortion & Misdirection System](features/09_Psychological_Distortion_System.md) | Ciri khas horor psikologis game ini; butuh Story Engine (#8) sudah ada supaya efeknya bisa dipicu oleh flag/chapter. | Belum dikerjakan |
...
| 15 | [External Map (Kampus)](features/15_External_Maps.md) | Scene terpisah (cuma 1 ruang kelas), hanya dipakai sekali di awal Prologue — bisa dikerjakan paralel/belakangan tanpa blokir chapter lain. | Belum dikerjakan |
